...
class DropdownView extends React.Component {
    render() {
        const _a = this.props, { options, item, questionnaire, id, answer, handleChange, selected, validateInput, resources, children, repeatButton, renderDeleteButton, renderOpenField, renderHelpButton, renderHelpElement, onRenderMarkdown } = _a, other = tslib_1.__rest(_a, ["options", "item", "questionnaire", "id", "answer", "handleChange", "selected", "validateInput", "resources", "children", "repeatButton", "renderDeleteButton", "renderOpenField", "renderHelpButton", "renderHelpElement", "onRenderMarkdown"]);
        if (!options) {
            return null;
        }
