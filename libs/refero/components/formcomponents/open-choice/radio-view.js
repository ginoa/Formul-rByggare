...
const RadioView = (_a) => {
    var { options, item, questionnaire, id, handleChange, selected, validateInput, resources, children, getErrorMessage, repeatButton, renderDeleteButton, renderOpenField, answer, renderHelpButton, renderHelpElement, onRenderMarkdown } = _a, other = tslib_1.__rest(_a, ["options", "item", "questionnaire", "id", "handleChange", "selected", "validateInput", "resources", "children", "getErrorMessage", "repeatButton", "renderDeleteButton", "renderOpenField", "answer", "renderHelpButton", "renderHelpElement", "onRenderMarkdown"]);
    if (!options) {
        return null;
    }
    const subLabelText = (0, index_1.getSublabelText)(item, onRenderMarkdown, questionnaire, resources);
    return (React.createElement("div", { className: "page_refero__component page_refero__component_openchoice page_refero__component_openchoice_radiobutton" },
