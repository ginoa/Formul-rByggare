...
const CheckboxView = (_a) => {
    var { options, item, questionnaire, id, answer, handleChange, selected, resources, children, repeatButton, renderDeleteButton, renderOpenField, renderHelpButton, renderHelpElement, onRenderMarkdown } = _a, other = tslib_1.__rest(_a, ["options", "item", "questionnaire", "id", "answer", "handleChange", "selected", "resources", "children", "repeatButton", "renderDeleteButton", "renderOpenField", "renderHelpButton", "renderHelpElement", "onRenderMarkdown"]);
    if (!options) {
        return null;
    }
    ...
    return (React.createElement("div", { className: "page_refero__component page_refero__component_openchoice page_refero__component_openchoice_checkbox" },
