export const getResources = (language: string): { [id: string]: string } => {
    ...
    if (language === 'sv-SE') {
        return {
            ...
            validationSummaryHeader: 'Kolla att följande är korrekt ifyllt:',
            validationFileMax: 'Filstorleken måste vara mindre än 25MB',
            validationFileType: 'Filtypen måste vara jpeg, png, eller pdf',
            supportedFileFormats: 'Giltiga filformater är jpeg, png och pdf',
            selectDefaultPlaceholder: 'Välj...',
            resetTime: 'Nollställ tidpunkt',
            errorAfterMaxDate: 'Datumet får inte infalla efter maxdatum',
            errorBeforeMinDate: 'Datumet får inte infalla före mindatum',
            dateRequired: 'Ange ett datum',
            oppgiTid: 'Ange ett klockslag',
            ugyldigTid: 'Ogiltigt klockslag',
            oppgiDatoTid: 'Ange datum och klockslag',
            ugyldigDatoTid: 'Ogiltigt datum och klockslag',
            oppgiVerdi: 'Ange ett värde',
            oppgiGyldigVerdi: 'Ange ett giltigt värde',
            formCancel: 'Avbryt',
            formSend: 'Skicka',
            formSave: 'Visa QuestionnaireResponse',
            formError: 'Kolla att allt är korrekt ifyllt.',
            formOptional: '(valfritt)',
            formRequired: '(måste fyllas i)',
            repeatButtonText: 'Lägg til',
            avsluttSkjema: 'Avslut schema',
            fortsett: 'Fortsätt ändra',
            confirmDeleteButtonText: 'Ta bort ändringar',
            confirmDeleteCancelButtonText: 'Avbryt',
            confirmDeleteHeading: 'Det finns osparade ändringar',
            confirmDeleteDescription: 'Om du fortsätter, kommer du tappa ändringarna.',
            minutePlaceholder: 'mm',
            hourPlaceholder: 'tt',
            ikkeBesvart: 'Inte besvarat',
            uploadButtonText: 'Ladda upp fil',
            filterDateCalendarButton: 'Välj datum',
            filterDateNavigateBackward: 'Tillbaka',
            filterDateNavigateForward: 'Fram',
            filterDateErrorDateFormat: 'Datumet är angivet med fel format',
            filterDateErrorBeforeMinDate: 'Från-datum får inte infalla tidigare än mindatum',
            filterDateErrorAfterMaxDate: 'Från-datum får inte infalla efter maxdatum',
            validationNotAllowed: 'är otillåtet',
            formRequiredErrorMessage: 'Fältet måste fyllas i',
            deleteAttachmentText: 'Radera',
            autoSuggestLoadError: 'Tekniskt fel',
            autosuggestNoSuggestions: 'Inga resultat hittade för "{0}". Försök med ett annat ord eller kolla eventuella stavfel.',
            stringOverMaxLengthError: 'Du har angivit för många tecken. Korta ner texten.',
            maxLengthText: 'Max {0} tecken',
            chooseFilesText: 'Välj filer',
            skipLinkText: 'Gå till navigator',
            clearDate: 'Ta bort datum',
            calendarLabel: 'Kalender',
            closeDatePicker: 'Stäng',
            focusStartDate: 'Använd kalendern och välj ett datum',
            jumpToPrevMonth: 'Till föregående månad',
            jumpToNextMonth: 'Till nästkommande månad',
            keyboardShortcuts: 'Kortkommandon',
            showKeyboardShortcutsPanel: 'Öppna kortkommando-panelen',
            hideKeyboardShortcutsPanel: 'Stäng kortkommando-panelen',
            enterKey: 'Returtangen',
            leftArrowRightArrow: 'Höger och Vänster piltangenter',
            upArrowDownArrow: 'Upp och Ner piltangenter',
            pageUpPageDown: 'Sida upp och Sida ner tangenter',
            homeEnd: 'Home- och End- tangenter',
            escape: 'Esc-tangent',
            questionMark: 'Frågetecken',
            openThisPanel: 'Öppna denna panel',
            selectFocusedDate: 'Välj datum i fokus',
            moveFocusByOneDay: 'Skifta fokus en dag bakåt (vänster) och framåt (höger)',
            moveFocusByOneWeek: 'Skifta fokus en vecka bakåt (upp) och framåt (ner)',
            moveFocusByOneMonth: 'Byt månad',
            moveFocustoStartAndEndOfWeek: 'Gå till första eller sista dagen i aktuella månaden',
            returnFocusToInput: 'Returnera till datum i input-fältet',
            year_field_invalid: 'Ange ett giltigt värde för År-fältet',
            year_field_maxdate: 'Senaste valbara år',
            year_field_mindate: 'Tidigaste valbara år',
            year_field_required: 'År måste anges',
            yearmonth_field_invalid: 'Ogitlgit värde',
            yearmonth_field_invalid_year: 'Ett giltigt värde måste fyllas i',
            yearmonth_field_maxdate: 'Senaste valbara perioden',
            yearmonth_field_mindate: 'Tidigaste valbara perioden',
            yearmonth_field_month_placeholder: 'Välj månad',
            yearmonth_field_required: 'År och månad krävs',
            yearmonth_field_year_placeholder: 'Välj år',
            adresseKomponent_header: 'Vem är mottagare av schemat?',
            adresseKomponent_skjemaSendesTil: 'Formuläret skickas till:',
            adresseKomponent_sublabel: 'Du måste välja en mottagare innan du skickar formuläret.',
            adresseKomponent_velgAvdeling: 'Välj avdelning',
            adresseKomponent_velgHelseforetak: 'Välj företag',
            adresseKomponent_velgHelseregion: 'Välj region',
            adresseKomponent_velgSykehus: 'Välj sjukhus',
            adresseKomponent_velgKlinikk: 'Välj klinik',
            adresseKomponent_velgSeksjon: 'Välj sektion',
            adresseKomponent_velgSengepost: 'Välj sängpost',
            adresseKomponent_velgPoliklinikk: 'Välj polyklinik',
            adresseKomponent_velgTjeneste: 'Välj behandlingsplats',
            adresseKomponent_feilmelding: 'Du måste välja en mottagare.',
            adresseKomponent_loadError: 'Tekinskt fel. Kunde inte hitta mottagare.',
            linkOpensInNewTab: 'Öppnas i nytt fönster',
            nextStep: 'Nästa',
            previousStep: 'Föregående',
            openChoiceOption: 'Annat',
        };
    }
    return {
